  ...
  variants: {
    state: {
      ...
      error: {
        ...
        icon: 'border-error-50 bg-error-100 text-error-600 dark:border-error-500/30 dark:bg-red-500/5 dark:text-error-400',
        deleteButton:
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm text-error-600 dark:text-error-200">
              {name}
            </span>
          </div>
